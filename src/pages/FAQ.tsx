  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "Contact our customer service at returns@zavira.com with your order number. We'll provide a return authorization and instructions. Refunds are processed within 5-10 business days of receiving your return."
      },
      {
          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <div className="space-y-12">
              {faqCategories.map((category, index) => (
                <div key={index}>
                  <h2 className="font-display text-2xl font-medium mb-6">{category.title}</h2>
            ...
            {/* Contact CTA */}
            <div className="mt-16 text-center bg-card border border-border p-8 lg:p-12">
              <h2 className="font-display text-2xl font-medium mb-4">Still Have Questions?</h2>
              <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
                Our concierge team is available to assist you with any questions not covered here.
              </p>
              <a 
                href="/contact" 
                className="inline-flex items-center justify-center px-8 py-3 bg-primary text-primary-foreground font-medium text-sm uppercase tracking-wider hover:bg-primary/90 transition-colors"
              >
                Contact Us
              </a>
            </div>

...
export const metadata: Metadata = {
    title: 'Shipping & Returns | Zavira Parfums',
    description: 'Learn about Zavira Parfums shipping options, delivery times, and hassle-free return policy.',
};

/**
 * Shipping & Returns Page - Server Component
 */
